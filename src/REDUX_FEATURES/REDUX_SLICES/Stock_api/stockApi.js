...
// // REDUX_SLICES/Stock_api/stockApi.js
// //
// // RTK Query for product-stocks endpoint (read-only stock view)
...
//                 if (result?.data) {
//                     return [
//                         ...result.data.map(({ stock_id }) => ({ type: "Stock", id: stock_id })),
//                         { type: "Stock", id: "LIST" },
//                     ];
//                 }
...
//         // GET /product-stocks with all records (for stats)
//         getAllProductStocks: builder.query({
//             query: ({ warehouse_id = "" }) => {
