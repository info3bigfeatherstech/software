...
//     const dispatch = useDispatch();
//     const { customerMobileInput, selectedCustomer } = useSelector((state) => state.billing);
//     const [triggerSearch, { data: searchResults, isLoading }] = useLazySearchCustomersQuery();
...
//             if (selectedCustomer && selectedCustomer.mobile !== value) {
//                 dispatch(setSelectedCustomer(null));
//             }
//         }
//     };
...
//                             <p className="font-semibold text-gray-800">{foundCustomer.name}</p>
//                             <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getLoyaltyBadge(foundCustomer.loyalty_tier)}`}>
//                                 {foundCustomer.loyalty_tier || "BRONZE"}
//                             </span>
//                         </div>
//                         <button
//                             onClick={handleClearCustomer}
