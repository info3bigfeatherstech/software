...
//             // FIX: `instanceof Blob` can fail when the Blob originates from a different
//             // frame/context. Use duck-typing instead: check for .size and .type properties.
//             // Also accept any octet-stream or pdf MIME that Axios may return.
...
//                 toast.success("PDF downloaded");
//             } else {
//                 console.error("Unexpected PDF response type:", typeof response, response);
//                 toast.error("PDF generation failed. Unexpected response from server.");
//             }
//         } catch (err) {
//             console.error("PDF download error:", err);
//             toast.error(err?.data?.message || "Failed to download PDF");
