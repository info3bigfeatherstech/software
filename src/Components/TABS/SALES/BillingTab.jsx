...
const BillingTab = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Satoshi', system-ui, -apple-system, sans-serif" }}>
      <div className="p-6">
        <div className="grid grid-cols-12 gap-6">
          {/* LEFT PANEL - Products */}
          <div className="col-span-7 bg-white border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            {/* Header */}
            <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-0.5">Browse & add items to cart</p>
              </div>
              <select
                value={selectedShop}
                onChange={(e) => setSelectedShop(e.target.value)}
                className="bg-white border border-gray-200 text-gray-700 text-sm rounded-lg px-4 py-2 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 cursor-pointer"
              >
                {shops.map((shop) => (
            ...
            <div className="px-6 pt-4 pb-2">
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 text-gray-900 text-sm rounded-lg px-4 py-2.5 pl-10 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 placeholder:text-gray-400"
                />
            ...
            {/* Product Grid */}
            <div className="px-6 pb-6 pt-2 overflow-y-auto flex-1" style={{ maxHeight: 'calc(100vh - 280px)' }}>
              {filteredProducts.length === 0 ? (
                <div className="text-center py-16">
                  <p className="text-gray-500 font-medium">No products found</p>
                  <p className="text-gray-400 text-sm mt-1">Add products in Inventory</p>
                </div>
              ) : (
                  ...
                  {filteredProducts.map((product) => (
                    ...
                    >
                      <div className="flex justify-between items-start gap-2">
                        <p className="text-gray-900 font-medium text-sm line-clamp-2 flex-1">
                          {product.name}
                        </p>
                      ...
                      <div className="mt-3 flex justify-between items-end">
                        <p className="text-xl font-bold text-gray-900">
                          ₹{toNumber(product.retail || product.mrp).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                        </p>
                        <p className="text-[10px] text-gray-400 font-mono">
                          {product.barcode ? product.barcode.slice(-6) : '—'}
                        </p>
                      </div>
                    </button>
                  ))}
          ...
          <div className="col-span-5 bg-white border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            {/* Header */}
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-0.5">Review & complete transaction</p>
                </div>
              ...
              {isGstBill && currentShopObj?.gstNumbers?.length > 1 && (
                <div className="mt-4 pt-4 border-t border-gray-100">
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 text-gray-700 text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 bg-white"
                  >
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 text-gray-900 text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 placeholder:text-gray-400"
                  />
                </div>
                <div>
                  <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-wider mb-1.5">
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-xl border border-blue-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-900 text-xs font-medium">Returning Customer</p>
                      <div className="flex gap-4 mt-1.5">
                        <div>
                          <p className="text-[9px] text-gray-500">Frequent Item</p>
                          <p className="text-xs text-gray-700 font-medium mt-0.5">{customerHistory.frequentItem}</p>
                        </div>
                        <div>
                          <p className="text-[9px] text-gray-500">Total Spend</p>
                          <p className="text-xs text-gray-700 font-medium mt-0.5">₹{customerHistory.totalSpend.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {appliedCredit && (
                <div className="mt-4 p-3 bg-green-50 rounded-xl border border-green-100 flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium text-green-700">Credit Note Applied</p>
                    <p className="text-[10px] text-green-600">From returned invoice</p>
                  </div>
                  <p className="text-xl font-bold text-green-700">
                    -₹{toNumber(appliedCredit.amount).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="divide-y divide-gray-50">
                {cart.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <p className="text-gray-400 text-sm mt-1">Scan or search products</p>
                  </div>
                ) : (
                  cart.map((item) => (
                    <div key={item.productId} className="px-5 py-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            <select
                              ...
                              className="text-[10px] bg-gray-50 border border-gray-200 rounded px-2 py-1 text-gray-600 focus:outline-none"
                            >
                            ...
                            {isGstBill && (
                              <span className="text-[9px] text-gray-400">GST {item.gst}%</span>
                            )}
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-2 bg-gray-50 rounded-lg border border-gray-200">
                            <button
                              ...
                              className="w-7 h-7 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-l-lg transition-colors"
                            >
                              -
                            </button>
                            <input
                              ...
                              className="w-10 text-center bg-transparent text-gray-900 text-sm font-medium focus:outline-none"
                            />
                            <button
                              onClick={() => updateQuantity(item.productId, item.quantity + 1)}
                              className="w-7 h-7 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-r-lg transition-colors"
                            >
                              +
                            </button>
                          </div>
                          <div className="text-right min-w-[80px]">
                            <p className="text-gray-900 font-semibold">₹{toNumber(item.total).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</p>
                            <p className="text-[10px] text-gray-400">@ ₹{toNumber(item.price).toLocaleString()}</p>
                          </div>
                          <button
            ...
            <div className="border-t border-gray-100 p-5 bg-gray-50/50">
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">₹{calculateSubtotal().toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                </div>
                {isGstBill && (
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">GST Amount</span>
                    <span className="text-gray-900">₹{calculateGST().toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                  </div>
                )}
                {appliedCredit && (
                  <div className="flex justify-between text-sm text-green-600">
                    <span>Credit Note</span>
                    <span>-₹{toNumber(appliedCredit.amount).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                  </div>
                )}
                <div className="flex justify-between items-center pt-3 border-t border-gray-200 mt-3">
                  <span className="text-gray-900 font-semibold">Total Payable</span>
                  <span className="text-2xl font-bold text-gray-900">
                    ₹{getFinalTotal().toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                  </span>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-5">
                <select
                  ...
                  className="flex-1 border border-gray-200 text-gray-700 text-sm rounded-lg px-4 py-2.5 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 bg-white cursor-pointer"
                >
                ...
                <button
                  onClick={() => {
                    saveBill();
                    setTimeout(() => {
                      alert(`WhatsApp receipt sent to ${customerMobile || 'Customer'}`);
                    }, 1000);
                  }}
...
// // Safe number parsing to prevent string concatenation bugs like "0520"
// const toNumber = (value, defaultValue = 0) => {
//     const num = Number(value);
//     return isNaN(num) ? defaultValue : num;
// };
...
//         setProducts(allProducts.filter(p => p.shopId === selectedShop && p.isActive !== false));
//         setShops(allShops);
//         setBills(allBills);
        
//         const currentShop = allShops.find(s => s.id === selectedShop);
//         if (currentShop && currentShop.gstNumbers && currentShop.gstNumbers.length > 0) {
//             setSelectedGstNumber(currentShop.gstNumbers[0]);
//         } else {
//             setSelectedGstNumber('');
//         }
...
//         const priceValue = toNumber(product[defaultPriceType] || product.mrp || 0);
...
//                 gst: toNumber(product.gst),
//                 total: priceValue,
//                 productRef: product // Keep reference to original product for price changes
//             }]);
//         }
//     };
...
//     // Update price type (MRP, Wholesale, Retail, Online)
//     const updatePriceType = (productId, newPriceType) => {
//         setCart(cart.map(c => {
...
//     // Calculations - Ensured pure numbers
//     const calculateSubtotal = () => cart.reduce((sum, c) => sum + toNumber(c.total), 0);
//     const calculateGST = () => isGstBill ? cart.reduce((sum, c) => sum + (toNumber(c.total) * toNumber(c.gst) / 100), 0) : 0;
//     const calculateTotal = () => calculateSubtotal() + calculateGST();
    
//     const getFinalTotal = () => {
//         const total = calculateTotal();
//         if (appliedCredit) {
//             const creditAmount = toNumber(appliedCredit.amount);
...
//     const checkCustomerCredit = (mobile) => {
//         if (mobile.length !== 10) return;
//         const creditNotes = getData(STORAGE_KEYS.CREDIT_NOTES, []);
//         const activeCredit = creditNotes.find(cn => cn.customerMobile === mobile && !cn.redeemed);
//         if (activeCredit) {
//             const normalizedCredit = { ...activeCredit, amount: toNumber(activeCredit.amount) };
//             setAppliedCredit(normalizedCredit);
//             alert(`💰 Credit note found: ₹${normalizedCredit.amount} available`);
//         } else {
//             setAppliedCredit(null);
//         }
//     };
...
//                             ${bill.gstBill ? `<tr><td>GST:</td><td class="right">₹${bill.gstAmount.toFixed(2)}</td></tr>` : ''}
//                             ${bill.creditApplied > 0 ? `<tr><td>Credit Applied:</td><td class="right">-₹${bill.creditApplied.toFixed(2)}</td></tr>` : ''}
//                             <tr class="bold"><td style="font-size: 14px; padding-top: 5px;">TOTAL:</td><td class="right" style="font-size: 14px; padding-top: 5px;">₹${bill.total.toFixed(2)}</td></tr>
//                         </table>
//                     </div>
//                     <div class="center" style="font-size: 12px;">
//                         <p class="sub-text">Payment: ${bill.paymentMethod.toUpperCase()}</p>
...
//         if (customerMobile && customerMobile !== 'WALKIN') {
//             const existingCustomer = allCustomers.find(c => c.mobile === customerMobile);
//             if (existingCustomer) {
...
//             } else {
//                 saveData(STORAGE_KEYS.CUSTOMERS, [...allCustomers, {
//                     id: `CUST-${Date.now()}`,
//                     name: customerName,
//                     mobile: customerMobile,
//                     totalPurchases: newBill.total,
...
//         if (appliedCredit) {
//             const allCreditNotes = getData(STORAGE_KEYS.CREDIT_NOTES, []);
//             const updatedCreditNotes = allCreditNotes.map(cn => 
//                 cn.id === appliedCredit.id 
//                     ? { ...cn, redeemed: true, redeemedAt: newBill.id, redeemedAtShop: selectedShop }
//                     : cn
//             );
//             saveData(STORAGE_KEYS.CREDIT_NOTES, updatedCreditNotes);
//         }
...
//                         />
//                         <button type="submit" disabled={showScanner} className="absolute inset-y-0 right-0 px-4 text-sm font-medium text-white bg-blue-600 rounded-r-lg hover:bg-blue-700 disabled:opacity-50">
//                             Add
//                         </button>
//                     </form>
...
//                                 <div className="mt-auto flex justify-between items-end w-full">
//                                     <div>
//                                         <p className="text-xs text-gray-500 font-mono">{product.barcode.slice(-6)}</p>
//                                         <p className="font-bold text-blue-600">₹{toNumber(product.retail || product.mrp).toFixed(2)}</p>
//                                     </div>
//                                     <span className={`text-xs px-1.5 py-0.5 rounded font-medium ${toNumber(product.stock) <= toNumber(product.lowStockAlert) ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
//                                         {product.stock} left
//                                     </span>
//                                 </div>
//                             </button>
...
//                 {/* Bill Header (GST Toggle & Customer) */}
//                 <div className="space-y-3 mb-4 flex-shrink-0">
//                     <div className="flex justify-between items-center border-b pb-3">
//                         <h3 className="font-bold text-gray-800 text-lg flex items-center gap-2">
//                             🛒 Checkout
...
//                             <button 
//                                 onClick={() => setIsGstBill(false)} 
//                                 className={`px-3 py-1 text-xs font-semibold rounded-md transition-all ${!isGstBill ? 'bg-white shadow text-gray-800' : 'text-gray-500 hover:text-gray-700'}`}
//                             >
//                                 Estimate
//                             </button>
//                             <button 
//                                 onClick={() => setIsGstBill(true)} 
//                                 className={`px-3 py-1 text-xs font-semibold rounded-md transition-all ${isGstBill ? 'bg-blue-600 shadow text-white' : 'text-gray-500 hover:text-gray-700'}`}
//                             >
//                                 GST Bill
//                             </button>
//                         </div>
...
//                                 onChange={(e) => {
//                                     setCustomerMobile(e.target.value);
//                                     if (e.target.value.length === 10) checkCustomerCredit(e.target.value);
//                                 }}
//                                 className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
//                             />
//                         </div>
...
//                                 <p className="text-xs text-green-600">From Return Note</p>
//                             </div>
//                             <p className="text-lg font-bold text-green-700">-₹{toNumber(appliedCredit.amount).toFixed(2)}</p>
//                         </div>
//                     )}
//                 </div>
...
//                                                     <option value="online">Online (₹{toNumber(item.productRef.online || 0)})</option>
//                                                 </select>
//                                                 {isGstBill && <span className="text-[10px] text-gray-400">GST: {item.gst}%</span>}
//                                             </div>
//                                         </td>
//                                         <td className="px-3 py-3">
//                                             <div className="flex items-center justify-center border border-gray-300 rounded bg-white">
//                                                 <button onClick={() => updateQuantity(item.productId, item.quantity - 1)} className="px-2 py-0.5 text-gray-500 hover:bg-gray-100">-</button>
//                                                 <input 
//                                                     type="number" 
//                                                     value={item.quantity} 
//                                                     onChange={(e) => updateQuantity(item.productId, e.target.value)}
...
//                                         </td>
//                                         <td className="px-2 py-3 text-center">
//                                             <button onClick={() => removeFromCart(item.productId)} className="text-red-400 hover:text-red-600 bg-red-50 hover:bg-red-100 p-1.5 rounded-md">
//                                                 🗑️
//                                             </button>
//                                         </td>
//                                     </tr>
...
//                         <div className="flex justify-between items-center pt-2">
//                             <span className="text-lg font-bold text-gray-800">NET PAYABLE:</span>
//                             <span className="text-2xl font-black text-blue-600">₹{getFinalTotal().toFixed(2)}</span>
//                         </div>
//                     </div>
...
//                             }`}
//                         >
//                             <span>🖨️</span> Print Bill & Complete
//                         </button>
//                     </div>
//                 </div>
