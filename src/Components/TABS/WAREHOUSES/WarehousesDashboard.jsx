// TABS/WAREHOUSES/WarehousesDashboard.jsx
//
// Owns the horizontal tab bar for the Warehouses section.
// Add new sub-tabs in warehousesTabRegistry.js only — nothing here changes.
...
//     const activeCtab = searchParams.get("ctab") || WAREHOUSES_TAB_REGISTRY[0]?.id;
//     const activeConfig = WAREHOUSES_TAB_REGISTRY.find(t => t.id === activeCtab) || WAREHOUSES_TAB_REGISTRY[0];
//     const SubComponent = activeConfig?.component ?? null;
...
//             {/* ── Horizontal tab bar ─────────────────────────────────────────── */}
//             <div className="flex items-center gap-1 border-b border-gray-200 mb-6">
//                 {WAREHOUSES_TAB_REGISTRY.map((tab) => {
//                     const isActive = activeCtab === tab.id;
//                     return (
//                         <button
//                             key={tab.id}
