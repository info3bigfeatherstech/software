// TABS/UTILITIES/UtilitiesDahboard.jsx
//
// Owns the horizontal tab bar for the Utilities section.
// Add new sub-tabs in UtilitiesTabRegistry.js only — nothing here changes.
    ...
    if (filteredTabs.length === 0) {
        return (
            <div className="text-center py-20 text-gray-400 text-sm">
                No utilities tabs available for your role.
            </div>
        );
    }
