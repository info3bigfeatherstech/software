// TABS/INVENTORY/InventoryDashboard.jsx
//
// Owns the horizontal tab bar for the Inventory section.
// Add new sub-tabs in inventoryTabRegistry.js only — nothing here changes.
    ...
    if (filteredTabs.length === 0) {
        return (
            <div className="text-center py-20 text-gray-400 text-sm">
                No inventory tabs available for your role.
            </div>
        );
    }
