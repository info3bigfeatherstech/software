// TABS/BACKUP/BackupDashboard.jsx
//
// Owns the horizontal tab bar for the Backup section.
// Add new sub-tabs in BackupTabregistry.js only — nothing here changes.
    ...
    if (filteredTabs.length === 0) {
        return (
            <div className="text-center py-20 text-gray-400 text-sm">
                No backup tabs available for your role.
            </div>
        );
    }
